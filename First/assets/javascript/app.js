$(document).ready(function () {
    ...
    ****************************************/
    // Weather
    var APIKeyWeather = "90a3db80fa91ca69d88cc81fff6bce71"; // Your OpenWeather API key
    var city = "Bangalore,IN"; // Bangalore, India
    var queryURLWeather = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=${APIKeyWeather}`;
    ...
    function getWeather() {
        $.ajax({
            ...
            var iconWeather = $("<img class='weather-icon' src='https://openweathermap.org/img/wn/" + response.weather[0].icon + ".png' alt='Weather in Bangalore, IN'>");
            console.log(response.weather[0].icon);
    
            var temperature = Math.round(response.main.temp); // Temperature in Celsius
            var temp = $("<p class='temp'>" + temperature + "°C</p>");
            console.log(temperature);
    
            var weatherDescription = $("<p class='weather-desc'>" + response.weather[0].description + "</p>");
...
/**document.addEventListener("DOMContentLoaded", function () {
    // Array of scenic background image URLs
    var backgroundImages = [
        "https://source.unsplash.com/1600x900/?nature,forest",
        "https://source.unsplash.com/1600x900/?mountains,landscape",
        "https://source.unsplash.com/1600x900/?greenery,scenery",
        "https://source.unsplash.com/1600x900/?waterfall,nature",
        "https://source.unsplash.com/1600x900/?river,forest",
        "https://source.unsplash.com/1600x900/?hills,scenic"
    ];

    // Pick a random background image
    var randomIndex = Math.floor(Math.random() * backgroundImages.length);
    var selectedBackground = backgroundImages[randomIndex];
